@extends('app')
@section('content')
    <a href="{{ route('alternatif.create') }}" class="btn btn-primary mb-3 d-flex align-items-center"
        style="gap: 5px; width: fit-content;"><i class='bx  bx-plus'></i> Tambah Alternatif</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('alternatif.edit', $alternatif->id_alternatif) }}"
                                class="btn btn-sm btn-warning"><i class='bx bx-edit'></i> Edit</a>
